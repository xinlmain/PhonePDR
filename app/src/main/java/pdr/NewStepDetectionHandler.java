...
/**
 * Created by Xin on 2016/8/27.
 */
public class NewStepDetectionHandler implements SensorEventListener {
    //存放三轴数据
    ...
    private StepDetectionListener mStepListeners;

    private ArrayList stepList = new ArrayList();

    private CalorieInfo mCalorieInfo;

    public void SensorChangeListener(CalorieInfo calorieInfo) {
        this.mCalorieInfo = calorieInfo;
    }

    public void setStepListener(@Nullable StepDetectionListener stepListener) {
